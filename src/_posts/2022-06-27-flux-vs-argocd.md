...
An often occuring scenario is to install applications in a (partial) order, e.g. you want infrastructure applications (e.g. an ingress) deployed before any service app.
