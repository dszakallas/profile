...
![Tasks with dependencies]({{ "/assets/2017-02-07-concurrency-parallelism-understanding-io/ex1_dd.png" | absolute_url }})
...
![12345]({{ "/assets/2017-02-07-concurrency-parallelism-understanding-io/ex1_st.png" | absolute_url }})

![13245]({{ "/assets/2017-02-07-concurrency-parallelism-understanding-io/ex1_st_alt.png" | absolute_url }})
...
![13245]({{ "/assets/2017-02-07-concurrency-parallelism-understanding-io/ex1_mt.png" | absolute_url }})
...
[dataflow]: ({{ "/assets/2017-02-07-concurrency-parallelism-understanding-io/ex1_dd.png" | absolute_url }})
...
![Process and threads]({{ "/assets/2017-02-07-concurrency-parallelism-understanding-io/kernel_proc_thread.png" | absolute_url }})
...
![Illustration for synchronous blocking I/O]({{ "/assets/2017-02-07-concurrency-parallelism-understanding-io/sync_blocking.png" | absolute_url }})
<p>
  <em>
...
--------------------------------------------------------------------------------
![Illustration for synchronous non-blocking I/O]({{ "/assets/2017-02-07-concurrency-parallelism-understanding-io/sync_nb.png" | absolute_url }})
<p>
  <em>
...
--------------------------------------------------------------------------------
![Illustration for asynchronous non-blocking I/O]({{ "/assets/2017-02-07-concurrency-parallelism-understanding-io/async_nb.png" | absolute_url }})
<p>
  <em>
...
![animation showing the single threaded server]({{ "/assets/2017-02-07-concurrency-parallelism-understanding-io/single.gif" | absolute_url }})
...
![animation showing the multi threaded server]({{ "/assets/2017-02-07-concurrency-parallelism-understanding-io/multi.gif" | absolute_url }})
...
![animation showing the single threaded server]({{ "/assets/2017-02-07-concurrency-parallelism-understanding-io/uv.gif" | absolute_url }})
